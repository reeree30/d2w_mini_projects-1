...
export var AnswerTime = __class__("AnswerTime", [object], {
  __module__: __name__,
  get __init__() {
    return __get__(this, function (self, question_id) {
      self.id = question_id;
      self.start = time.time();
      self.end = -1;
    });
  },
  get _get_elapsedtime() {
    return __get__(this, function (self) {
      if (self.end == -1) self.stop();
...
Object.defineProperty(
  AnswerTime,
  "elapsedtime",
  property.call(AnswerTime, AnswerTime._get_elapsedtime)
);
export var Records = __class__("Records", [object], {
  ...
  get stop_timer() {
    return __get__(this, function (self, form_id, question_id) {
      ...
      curform.elements["elapsed_time"].value =
        self.py_items[question_id].elapsedtime;
      curform.submit();
    });
  },
  get get_elapsedtime() {
